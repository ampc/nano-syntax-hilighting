...
shifty.config.tags = {
	...
	["www"] = {init = false, position = 2, exclusive = true, max_clients = 1},
	["file"]  = {rel_index = 1},
...
shifty.config.apps = {
	...
	{match = {"browser","Firefox.*", "Vimperator", "Namoroka", "chrome"}, tag = "www"},
	{match = {"file manager","thunar"}, tag = "file"},
	{match = {"Gimp"}, tag = "gimp"}, 
	...
	{match = {"irssi"}, tag = "irc"},
	{match = {"finch"}, tag = "chat"},
	{match = {"cmus", "ncmpcpp"}, tag = "music"},
	{match = {"codeblocks", "eclipse"}, tag = "code"},
        {match = {"game"}, tag = "game"},
...
vicious.register(time_widget, vicious.widgets.date, "%b %d, %R", 60)
